...
/*
Description:
   Binary Node will take in Customer objects. It holds a pointer to a left child, and another pointer to a right child.
   The Customer Object will be stored on the heap and shared with the other parts of the program.
*/
