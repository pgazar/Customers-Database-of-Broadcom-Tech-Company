...
//A hash table is a data structure that stores data in units of pairs of keys and corresponding values, 
//and when a key is specified, the corresponding value can be obtained at high speed.
